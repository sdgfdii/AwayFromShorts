...
- 到 [Releases](https://github.com/sdgfdii/AwayFromShorts/releases) 下载 `AwayFromShorts-Setup-1.1.2.exe`
...
**Q: 杀进程会不会把我正在写的东西弄丢?**
屏蔽 Chrome/Edge 会关闭所有窗口,请把重要工作进程加入白名单,或选择不屏蔽进程。
